...
abstract contract StartfiMarketPlaceAdmin is Ownable, Pausable,StartfiMarketPlaceFinance {
    ...
    constructor(address ownerAddress, string memory _marketPlaceName,
        address _paymentContract,
        address _reputationContract) StartfiMarketPlaceFinance(_marketPlaceName, _paymentContract, _reputationContract){
     ...
     *  
     */
    function  changeListqualifyAmount(uint256 newFees, uint256 newBase) external onlyOwner whenPaused returns (uint256 percentage)  {
     ...
     *  
     */
    function  changeDelistFeesPerentage(uint256 newFees, uint256 newBase)   external onlyOwner whenPaused returns (uint256 percentage)  {
     ...
     *  
     */
    function  changeBidPenaltyPercentage(uint256 newFees, uint256 newBase) external onlyOwner whenPaused returns (uint256 percentage)  {
