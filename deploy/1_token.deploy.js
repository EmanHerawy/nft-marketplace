...
module.exports = async ({ getNamedAccounts, deployments }) => {
  const StartFiToken = await ethers.getContractFactory('StartFiToken')
  ...
  let name = 'StartFiToken',
    symbol = 'STFI'

  const constructorArgs = [name, symbol, deployer]
  ...
  const bytecode = `${StartFiToken.bytecode}${constructor}`
