...
const stfi_token= require('../deployments/computedAddreses.json').stfiToken;
// deploy/00_deploy_my_contract.js
module.exports = async ({  deployments,getNamedAccounts }) => {
  const StartFiStakes = await ethers.getContractFactory('StartFiStakes')
  ...
  const constructorArgs = [stfi_token,deployer]
  // const constructorArgs = [stfi_token.address]
  ...
  const bytecode = `${StartFiStakes.bytecode}${constructor}`
